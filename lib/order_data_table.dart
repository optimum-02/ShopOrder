...
import 'package:objectbox_sample/entities.dart';
...
class OrderDataTable extends StatefulWidget {
  ...
  @override
  OrderDataTableState createState() => OrderDataTableState();
}

class OrderDataTableState extends State<OrderDataTable> {
